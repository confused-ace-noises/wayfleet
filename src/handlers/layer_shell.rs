...
impl<BD: BackendData> WlrLayerShellHandler for State<BD> {
    ...
    fn new_layer_surface(
        ...
        add_post_commit_hook::<Self, _>(layer.clone().wl_surface(), move |state, _, _| {
        ...
        self.layout_mut().update_available_state(available);
    }
